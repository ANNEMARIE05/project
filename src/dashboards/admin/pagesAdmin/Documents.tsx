...
export default function Documents() {
    ...
    const [clients, setClients] = useState<Client[]>([
        ...
        },
        {
            ...
            limiteMensuelle: 800,
            documentsConsommes: 650,
            documentsAttribues: 15
        },
        {
            id: '5',
            nom: 'Lucas Moreau',
            ...
            limiteMensuelle: 300,
            documentsConsommes: 120,
            documentsAttribues: 3
        },
        {
            id: '6',
            nom: 'Emma Petit',
            email: 'emma.petit@email.com',
            limiteMensuelle: 1500,
            documentsConsommes: 1400,
            documentsAttribues: 25
        },
        {
            id: '7',
            nom: 'Thomas Roux',
            ...
            limiteMensuelle: 400,
            documentsConsommes: 380,
            documentsAttribues: 7
        },
        {
            id: '8',
            nom: 'Julie Leroy',
            ...
            limiteMensuelle: 600,
            documentsConsommes: 420,
            documentsAttribues: 10
        },
        {
            id: '9',
            nom: 'Antoine Simon',
            ...
            limiteMensuelle: 750,
            documentsConsommes: 600,
            documentsAttribues: 18
        },
        {
            id: '10',
            nom: 'Camille Michel',
            email: 'camille.michel@email.com',
            limiteMensuelle: 900,
            documentsConsommes: 720,
            documentsAttribues: 22
        },
        {
            id: '11',
            nom: 'Hugo Garcia',
            email: 'hugo.garcia@email.com',
            limiteMensuelle: 1200,
            documentsConsommes: 950,
            documentsAttribues: 30
        },
        {
            id: '12',
            nom: 'Léa Rodriguez',
            email: 'lea.rodriguez@email.com',
            limiteMensuelle: 350,
            documentsConsommes: 280,
            documentsAttribues: 6
        }
    ]);
    ...
    const clientsPagination = clientsFiltres.slice(indexDebut, indexFin);
    const nombreTotalPages = Math.ceil(clientsFiltres.length / elementsParPage);
    ...
    const changerElementsParPage = (nouveauNombre: number) => {
        setElementsParPage(nouveauNombre);
        setPageCourante(1); // Reset to first page
    };
    ...
    const obtenirCouleurFondStatut = (client: Client) => {
        ...
        if (pourcentage >= 80) return 'bg-green-100';
    ...
    return (
        <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <div className="flex-1">
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      setRechercheClients(e.target.value);
                    }}
                    className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                  />
                  {rechercheClients && (
                    <button
                      onClick={() => setRechercheClients('')}
              ...
              <div className="flex items-center space-x-2">
                ...
                <select
                  ...
                  onChange={(e) => changerElementsParPage(parseInt(e.target.value))}
            ...
            {rechercheClients && (
              <div className="mt-3 pt-3 border-t border-gray-100">
                <p className="text-sm text-gray-600">
                  {clientsFiltres.length} résultat{clientsFiltres.length > 1 ? 's' : ''} trouvé{clientsFiltres.length > 1 ? 's' : ''} pour "{rechercheClients}"
                </p>
              </div>
            )}
          </div>
                ...
                <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                  <div>
                    <p className="text-xs text-gray-700">
                      Affichage de <span className="font-semibold">{indexDebut + 1}</span> à <span className="font-semibold">{Math.min(indexFin, clientsFiltres.length)}</span> sur <span className="font-semibold">{clientsFiltres.length}</span> résultat{clientsFiltres.length > 1 ? 's' : ''}
                    </p>
                  </div>
                  <div>
                    <nav className="relative z-0 inline-flex rounded-lg shadow-sm -space-x-px" aria-label="Pagination">
                      ...
                      {Array.from({ length: nombreTotalPages }, (_, i) => i + 1).map((page) => (
                        <button
                          key={page}
          ...
          {afficherModalSuppression && clientASupprimer && (
            <div className="fixed inset-0 bg-white/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-xl p-3 sm:p-4 w-full max-w-md shadow-xl">
                <div className="flex justify-between items-center mb-3">
