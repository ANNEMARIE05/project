        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-2 sm:p-4 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-medium text-gray-600">Tickets ouvert</p>
                ...
                <div className="w-6 h-6 sm:w-10 sm:h-10 bg-purple-100 rounded-lg flex items-center justify-center">
                  <Mail className="w-3 h-3 sm:w-5 sm:h-5 text-purple-600" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-4">
              ...
              <div className="space-y-2 sm:space-y-3">
                {activitesRecentes.map((activite) => {
                  const ComposantIcone = activite.icon;
                  const classesCouleur: Record<string, string> = {
                  ...
                  return (
                    <div key={activite.id} className="flex items-center space-x-2 sm:space-x-3">
                      <div className={`w-5 h-5 sm:w-6 sm:h-6 ${classesCouleur[activite.color]} rounded-lg flex items-center justify-center`}>
                        <ComposantIcone className="w-2.5 h-2.5 sm:w-3 sm:h-3" />
                      </div>
